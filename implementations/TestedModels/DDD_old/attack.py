...
for file_iteration in file_iteration_names:
    ...
    orig_images = Image.open(f'./dataset/{testimg_filename}.png').convert('RGB').resize((512,512))
    mask_image_orig = Image.open(f'./dataset/{testimg_filename}_masked.png').convert('RGB').resize((512,512))
    ...
    init_image = Image.open(f'./dataset/{testimg_filename}.png').convert('RGB').resize((512,512))
    mask_image = Image.open(f'./dataset/{testimg_filename}_masked.png').convert('RGB')
    mask_image = ImageOps.invert(mask_image).resize((512,512))
