...
def get_text_embedding_with_embeddings(self, prompt_ids, prompt_embeddings, attention_mask=None):
    text_embeddings = encode_embeddings(self,
        prompt_ids,
        prompt_embeddings,
...
def encode_embeddings(self, prompt, prompt_embeddings, attention_mask=None):
    ...
    causal_attention_mask = build_causal_attention_mask(bsz, seq_len, hidden_states.dtype).to(
